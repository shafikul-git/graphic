        ...
        <section class="mx-auto container grid grid-cols-2 gap-5 px-5 pb-10 md:hidden">
            ...
            <div class="flex flex-col">
                <div class="relative flex">
                    <img class="w-20 h-20" src="{{ 'frontend/assets/images/product-chair.png' }}" alt="sofa image" />
                    <div
        ...
        <section class="hidden w-full max-w-[1200px] grid-cols-1 gap-8 px-5 pb-10 md:grid">
            ...
            <div class="flex w-full flex-row h-44 items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img class="object-cover w-20 h-20" src="{{ 'frontend/assets/images/kitchen.png' }}"
                        alt="Kitchen image" />
            ...
            <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img class="object-cover w-20 h-20" src="{{ 'frontend/assets/images/bedroom.png' }}"
                        alt="Bedroom image" />
            ...
            <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img class="object-cover w-20 h-20" src="{{ 'frontend/assets/images/living-room.png' }}"
                        alt="Sofa image" />
            ...
            <div class="flex w-full h-44 flex-row items-center justify-between border py-5 px-4">
                <div class="flex w-full items-center gap-4">
                    <img class="object-cover w-20 h-20" src="{{ 'frontend/assets/images/product-chair.png' }}"
                        alt="Chair image" />
