...
<div class="bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 py-10 px-10 font-sans tracking-wide">
    <div class="max-w-2xl mx-auto text-center">
        <a href='javascript:void(0)' class="inline-block"><img src="https://readymadeui.com/readymadeui-light.svg"
                alt="logo" class='w-48' /></a>
        <p class="text-sm mt-8 text-gray-200">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean gravida,
