   <!-- sidebar  -->
   @push('todoMobileMenu')
   <section class="flex-shrink-0 px-4 md:hidden">
       <div class="border-b py-5">
           <div class="flex items-center">
               <img class="rounded-full object-cover h-10 w-10" src="{{ 'frontend/assets/images/avatar-photo.png' }}"
               ...
               <div class="flex w-full">
                   <div class="flex flex-col gap-2">
                       ...
                       <a href="manage-address.html"
                           class="text-gray-500 duration-100 hover:text-yellow-400">Manage Addresses</a>
                       <a href="change-password.html"
                           class="text-gray-500 duration-100 hover:text-yellow-400">Change password</a>
                   </div>
               </div>
           </div>
       </div>
       ...
       <div class="flex border-b py-5">
           <div class="flex w-full">
               <div class="flex flex-col gap-2">
                   <a href="wishlist.html" class="flex items-center gap-2 font-medium text-violet-900">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                           stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                           <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="py-5">
            <div class="flex items-center">
                <img class="rounded-full object-cover w-20 h-20"
                    src="{{ 'frontend/assets/images/avatar-photo.png' }}" alt="Red woman portrait" />
                <div class="ml-5">
                    <p class="font-medium text-gray-500">Hello,</p>
                    <p class="font-bold">Sarah Johnson</p>
                </div>
