                ...
                <div class="swiper-slide">
                    <div
                        ...
                        <div class="flex items-center">
                            ...
                            <img src="{{ $slide->image ?? url('frontend/image/slider/1.png') }}" class=" ml-6 rounded-full" loding="lazy" style="height: 200px; width: 300px;" />
                        </div>
                        <h3 class="text-gray-800 text-lg font-semibold mt-4">{{ $slide->title ?? 'Lorem, ipsum dolor sit amet consectetur adipisicing elit.' }}</h3>
                    </div>
                </div>
            @endforeach
