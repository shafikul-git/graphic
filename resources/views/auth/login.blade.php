...
<x-guest-layout>
    ...
    <div class="font-[sans-serif] block">
        <div class="grid lg:grid-cols-2 gap-4 max-lg:gap-12 bg-gradient-to-r from-blue-500 to-blue-700 px-8 py-12 ">
          <div>
          ...
          <div class="bg-white rounded-xl sm:px-6 px-4 py-8 max-w-md w-full h-max shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] max-lg:mx-auto">
            <form method="POST" action="{{ route('login') }}">
              ...
              <div>
                <label for="email" class="text-gray-800 text-sm mb-2 block">User Email</label>
                <div class="relative flex items-center">
                  <input id="email" class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter Email"  type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username" />
              ...
              <div class="mt-4">
                ...
                <div class="relative flex items-center">
                  <input name="password" type="password" id="password" required class="w-full text-sm text-gray-800 border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter password" autocomplete="current-password"/>
